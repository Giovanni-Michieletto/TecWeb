...
INSERT INTO Associazioni(Titolo, Immagine, AltImmagine, Testo) VALUES 
("Catechismo Santa Maria del Cengio", "./upload/Associazioni/catechismo.jpg", "foto del gruppo di catechismo", "Il percorso di catechesi segue le indicazioni diocesane che ci apprestiamo a ripercorrere l’antico ordine dei sacramenti. La cresima torna ad essere la conferma che ognuno dà alla scelta di seguire il Cristo, e la comunione il punto di arrivo del cammino di iniziazione che ci unisce a Gesù Cristo per divenire ogni giorno, domenica dopo domenica,  sempre più cristiani.
...
I sacramenti sono all’interno del percorso dei tre anni e necessitano del cammino completo per essere quello che sono.. cioè tappe e momenti speciali di accompagnamento alla vita della fede. Da soli slegati al percorso non hanno alcun senso. E’, per fare un esempio concreto , come se portassimo un ciclista in macchina a tagliare i traguardi delle tappe  percorrendo solo gli ultimi 100 metri di ogni tappa.. con la pretesa che sia un ciclista!");
 ...
 INSERT INTO Associazioni(Titolo, Immagine, AltImmagine, Testo) VALUES 
("Grest Santa Maria del Cengio", "./upload/Associazioni/grest.jpg", "foto del grest", "La parola Grest significa, letteralmente, “GRuppo ESTivo” ed è la “versione” estiva dell’oratorio dedicata ai più piccoli. 
...
INSERT INTO Associazioni(Titolo, Immagine, AltImmagine, Testo) VALUES 
("Associazione dei ciechi Santa Maria del Cengio", "./upload/Associazioni/ciechi.jpg", "foto del gruppo dell'associazione ciechi","Il gruppo dei ciechi è un'associazione di fedeli, ciechi e vedenti, per il servizio all'uomo, alle persone associate, alle comunità ecclesiali e alle comunità civili.
